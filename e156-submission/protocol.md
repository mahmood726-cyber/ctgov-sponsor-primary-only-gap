...
Protocol: CT.gov Sponsor Primary-Only Gap

This protocol isolates endpoint-only text gaps inside named-sponsor CT.gov portfolios. A primary-only gap is an eligible older closed interventional study missing the primary outcome description while retaining the detailed description field. Primary outputs rank named sponsors with at least 100 studies by stock and rate and compare sponsor-class patterns.
